      ...
      <RotatingGallery 
        ...
        centerContent={
          ...
          >
            ...
            >
              Your fourth and final memory story. This could be the most recent memory
              or one that holds special significance in your journey together.
            </motion.p>
            <motion.p
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              Share what makes this memory unique and how it has contributed to your bond.
            </motion.p>
